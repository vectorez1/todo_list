...
export const EraseButton = ({toDoList,setTodoList}) => {
  ...
  return (
    <button onMouseEnter={e=>setMouseIn(true)} onMouseLeave={e=>setMouseIn(false)} className=' transition-all h-[110px] w-[100%] bg-red-500 border-t-black border-t-[5px] flex justify-center items-center hover:bg-red-800'
            onClick={handleErase}>
        {
            !isMouseIn ? 
